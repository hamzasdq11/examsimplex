        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-6 items-center">
          ...
          <AnimatedSection animation="scale" delay={150} className="relative flex justify-center lg:justify-end mt-4 lg:mt-0">
            ...
            <div className="relative">
              ...
              <div 
                className="absolute top-1/4 -left-3 sm:-left-5 w-10 h-10 sm:w-14 sm:h-14 bg-card rounded-xl shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300" 
              ...
              <div 
                className="absolute bottom-8 sm:bottom-12 right-0 sm:-right-2 w-10 h-10 sm:w-14 sm:h-14 bg-card rounded-xl shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300" 
